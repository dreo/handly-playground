 ...
 *     Ondrej Ilcik (Codasip) - modifications for Java model
 *******************************************************************************/
    ...
    implements ILinkHelper
{
    ...
    public IStructuredSelection findSelection(IEditorInput editorInput)
    {
        if (editorInput instanceof IFileEditorInput)
        {
            ...
            ICompilationUnit fooFile = (ICompilationUnit)JavaModelCore.create(file);
            if (fooFile != null)
            {
                ...
                if (navigatorView != null)
                {
                        ...
                        && currentSelection.size() == 1)
                    {
                        ...
                        {
                            if (fooFile.equals(((IJavaElement)element).getAncestor(ICompilationUnit.class)))
